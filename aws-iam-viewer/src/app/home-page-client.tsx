    ...
    <div className="max-w-2xl mx-auto space-y-16 py-12">
      <div className="space-y-8">
        <div className="space-y-3">
          ...
          <h1 className="text-5xl font-bold leading-[1.05] tracking-tight">
            ...
            <br />
            <span className="text-primary">IAM permissions</span>
            <span className="text-muted-foreground">.</span>
          </h1>
          <p className="text-base text-muted-foreground max-w-lg leading-relaxed">
            Upload an <code className="font-mono text-xs bg-secondary px-1.5 py-0.5 text-primary/80">
      ...
      <div className="border border-border bg-card">
        ...
        <div className="p-8 space-y-6">
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center size-8 bg-primary/10">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div className="space-y-2">
              ...
              <Input
                ...
                className="font-mono text-sm bg-secondary/50 border-border focus:border-ring transition-colors"
              />
            </div>
              ...
              >
                <div className={`mb-3 transition-transform duration-150 ${isDragOver ? 'scale-110' : ''}`}>
                  {file ? (
                    ...
                    <Upload className={`size-10 mx-auto ${isDragOver ? 'text-primary' : 'text-muted-foreground/40'}`} />
                  )}
                </div>
                {file ? (
            ...
            <Button
              ...
              className="w-full h-11 font-bold text-sm uppercase tracking-wider bg-primary hover:bg-primary/90 text-primary-foreground transition-all disabled:opacity-40 disabled:cursor-not-allowed"
            >
              {isLoading ? (
      ...
      <div className="border border-border bg-card/50">
        <div className="p-8 space-y-4">
          ...
          <Alert className="border-l-2 border-l-primary/50 bg-primary/5">
            <Shield className="size-4 text-primary" />
            <AlertDescription className="text-xs">
              <span className="text-primary font-bold">LOCAL ONLY:</span> All processing happens in your browser.
