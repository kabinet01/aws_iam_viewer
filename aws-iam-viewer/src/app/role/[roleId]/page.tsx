  ...
  useEffect(() => {
    const loadRoleData = async () => {
      try {
        ...
        const assumableRoles = findAssumableRolesForRole(roleData, upload.data.roles as Record<string, IAMRole>);
        setAssumableRoles(assumableRoles);

        // Get roles that can assume this role
        const rolesThatCanAssume = Object.values(upload.data.roles as Record<string, IAMRole>).filter((otherRole: IAMRole) => {
