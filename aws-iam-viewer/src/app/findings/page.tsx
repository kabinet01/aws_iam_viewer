  ...
  return (
    <TableRow>
      ...
      <TableCell className="max-w-md">
        ...
        {finding.source && (
          <div className="text-xs font-mono text-muted-foreground mt-1">{finding.source.policyName}</div>
        )}
      </TableCell>
      <TableCell>
        <div className="font-medium">{finding.entityName}</div>
        <div className="text-xs text-muted-foreground">{finding.entityType}</div>
      </TableCell>
      <TableCell className="max-w-sm">
        <div className="text-xs text-muted-foreground line-clamp-3">{finding.evidence.join(" | ")}</div>
      </TableCell>
      <TableCell>
